...
### Relatoria e Sistematização de Políticas PCT
*2025 — presente · Brasília-DF / Remoto*
...
|-----------|-------------|
| **Pesquisa Etnográfica** | Observação participante, entrevistas em profundidade, pesquisa qualitativa com comunidades tradicionais, análise de território |
| **Relatoria e Documentação** | Sistematização de dados qualitativos, relatórios de incidência política, documentação de reuniões governamentais e eventos multi-stakeholder |
| **Políticas Públicas PCT** | CNPCT, regularização fundiária, unidades de conservação, articulação governo-sociedade civil |
| **Gestão e Análise de Dados** | Análise de métricas (Google Analytics, Meta), sistemas de informação geográfica (QGIS), ferramentas de IA aplicadas à pesquisa qualitativa, automação de processos |
| **Comunicação Estratégica** | Planejamento de comunicação, gestão de redes, produção multimídia, design editorial, fotografia documental |
