...
- **Encontro de Planejamento Estratégico do IPEA** (2026). Relatoria dos Movimentos 5 (Integração) e 7 (Gestão da Informação) com transcrição em tempo real via StênioREC e observação etnográfica. Evento de 3 dias contratado via **Imagine Gestão Social**, resultando na agenda estratégica 2026–2027 do instituto.
